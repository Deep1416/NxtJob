...
const FamiliarCarousel: React.FC = () => {
  ...
  return (
    <section
      className="overflow-x-hidden md:mt-12 lg:mb-32 p-4 md:px-20"
      ref={ref}
    >
      <div className="flex flex-row items-center justify-between">
        ...
        >
          <h1 className="text-xl md:text-3xl lg:text-5xl font-bold md:px-4 md:mb-5">
      ...
      >
        {[
          ...
          <div
            key={index}
            className={`z-50 rounded-xl ${bgColor} min-w-[350px] p-6 flex flex-col gap-4 hover:scale-110 hover:-rotate-12 hover:duration-300 ease-in-out`}
          >
...
export default FamiliarCarousel;
